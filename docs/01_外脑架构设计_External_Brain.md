...
| 存储类型 | 技术选型 | 用途 |
| :---- | :---- | :---- |
| **Hot Memory** | Embedded Hot Memory (e.g. Sled) | 24小时热点数据。 |
| **Vector Memory** | SQLite-vec/Embedded Vector DB | 语义向量索引。 |
| **Graph Memory** | Embedded Graph Store (petgraph+sqlite) | 实体关系图谱。 |
